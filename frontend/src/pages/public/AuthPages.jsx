...
export const LoginPage = () => {
  ...
  return (
    <AuthLayout title="Login" subtitle="Access your pharmacy platform account.">
...
export const RegisterPage = () => {
  ...
  return (
    <AuthLayout title="Register" subtitle="Create your customer account securely.">
      <form className="auth-form" onSubmit={onSubmit}>
...
export const ForgotPasswordPage = () => {
  ...
  return (
    <AuthLayout title="Forgot Password" subtitle="Reset your account password securely.">
      <form className="auth-form" onSubmit={onSubmit}>
