...
export const SellerPurchasesPage = () => {
  ...
  return (
    <div>
      <PageHeader title="Purchase Entry" subtitle="Record inbound stock entries and keep inventory totals synchronized." />
      ...
      <SectionCard title="Purchase history">
        <DataTable
          ...
          rows={rows}
          emptyText="No purchase entries recorded yet."
        />
      </SectionCard>
    </div>
  );
