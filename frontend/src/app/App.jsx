...
const sellerNav = [{ to: '/seller', label: 'Dashboard' }, { to: '/seller/medicines', label: 'Medicines' }, { to: '/seller/medicines/new', label: 'Add Product' }, { to: '/seller/inventory/batches', label: 'Batches' }, { to: '/seller/purchases', label: 'Purchases' }, { to: '/seller/alerts/low-stock', label: 'Low Stock' }, { to: '/seller/alerts/expiry', label: 'Expiry Alerts' }, { to: '/seller/transactions/import', label: 'Transaction Import' }];
const adminNav = [{ to: '/admin/dashboard', label: 'Dashboard' }, { to: '/admin/audit-logs', label: 'Audit Logs' }];
...
export const App = () => (
  <Routes>
    ...
    <Route
      path="/customer"
      element={<ProtectedRoute allowRoles={[ROLES.CUSTOMER]} loginPath="/login?role=customer"><AppShell title="Customer" navItems={customerNav} /></ProtectedRoute>}
    >
    ...
    <Route
      path="/seller"
      element={<ProtectedRoute allowRoles={[ROLES.SELLER, ROLES.PHARMACIST]} loginPath="/login?role=seller"><AppShell title="Seller" navItems={sellerNav} /></ProtectedRoute>}
    >
    ...
    <Route
      path="/admin"
      element={<ProtectedRoute allowRoles={[ROLES.ADMIN, 'super_admin']} loginPath="/login?role=admin" onRoleMismatch="login"><AppShell title="Admin" navItems={adminNav} /></ProtectedRoute>}
    >
    ...
    <Route
      path="/delivery"
      element={<ProtectedRoute allowRoles={[ROLES.DELIVERY]} loginPath="/login?role=delivery"><AppShell title="Delivery" navItems={deliveryNav} /></ProtectedRoute>}
    >
